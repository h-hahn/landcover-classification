...
***Convert Landsat values to reflectance*** I converted the values in the raster stack to correspond to reflectance values by removing erroneous values and applying any [scaling factors](https://www.usgs.gov/faqs/how-do-i-use-scale-factor-landsat-level-2-science-products#:~:text=Landsat%20Collection%202%20surface%20temperature,the%20scale%20factor%20is%20applied.) to convert to reflectance.\
